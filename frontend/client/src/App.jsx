        ...
        <div className="results">
          ...
          <div className="zipActions">
            {results.matched_zip_url && (
              <a className="linkBtn" href={results.matched_zip_url}>
                Download Matched ZIP
              </a>
            )}

            {results.not_matched_zip_url && (
              <a className="linkBtn linkBtnAlt" href={results.not_matched_zip_url}>
          ...
          <div className="galleryWrap">
             <div class="note112"> Note :- Preview of some of the images might be blocked by Add Blocker Extention in your Browser </div>
    ...
    <div className="howItWorks">
      ...
      <div className="steps">
        <div className="stepCard">
          ...
          <p className="stepDesc">You upload the face you want to search for and other multiple images that you want to sort.</p>
        </div>
